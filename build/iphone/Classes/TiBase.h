...
// in simulator we redefine to format for lostapp Developer console
...
{\
	NSString * exceptionName = [@"org.lostapp." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lostapp";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIlostappNativeItemNone = -1, 
	UIlostappNativeItemSpinner = -2,
	UIlostappNativeItemProgressBar = -3,
	
	UIlostappNativeItemSlider = -4,
	UIlostappNativeItemSwitch = -5,
	UIlostappNativeItemMultiButton = -6,
	UIlostappNativeItemSegmented = -7,
	
	UIlostappNativeItemTextView = -8,
	UIlostappNativeItemTextField = -9,
	UIlostappNativeItemSearchBar = -10,
	
	UIlostappNativeItemPicker = -11,
	UIlostappNativeItemDatePicker = -12,
	
	UIlostappNativeItemInfoLight = -13,
	UIlostappNativeItemInfoDark = -14,
	
	UIlostappNativeItemDisclosure = -15,
	
	UIlostappNativeItemContactAdd = -16
};
