...
// in simulator we redefine to format for Lost_Found Developer console
...
{\
	NSString * exceptionName = [@"org.lost_found." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.lost_found";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UILost_FoundNativeItemNone = -1, 
	UILost_FoundNativeItemSpinner = -2,
	UILost_FoundNativeItemProgressBar = -3,
	
	UILost_FoundNativeItemSlider = -4,
	UILost_FoundNativeItemSwitch = -5,
	UILost_FoundNativeItemMultiButton = -6,
	UILost_FoundNativeItemSegmented = -7,
	
	UILost_FoundNativeItemTextView = -8,
	UILost_FoundNativeItemTextField = -9,
	UILost_FoundNativeItemSearchBar = -10,
	
	UILost_FoundNativeItemPicker = -11,
	UILost_FoundNativeItemDatePicker = -12,
	
	UILost_FoundNativeItemInfoLight = -13,
	UILost_FoundNativeItemInfoDark = -14,
	
	UILost_FoundNativeItemDisclosure = -15,
	
	UILost_FoundNativeItemContactAdd = -16
};
